...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        # print(cols)
        # p2
        # num_train = int(len(df_raw) * (0.8813 if not self.train_only else 1))
        # num_test = int(len(df_raw) * 0.0710)
        # p1
        num_train = int(len(df_raw) * (0.5113 if not self.train_only else 1))
        num_test = int(len(df_raw) * 0.3510)
...
class Dataset_Pred(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.features == 'M' or self.features == 'MS' or self.features == 'MM':
            ...
            df_raw = df_raw[['date'] + df_raw.columns[:3]]
